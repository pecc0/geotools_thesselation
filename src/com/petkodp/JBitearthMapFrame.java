 ...
 * @version $Id$
 */
public class JBitearthMapFrame extends JFrame {
     ...
     * UI elements
     */
    private JBitearthMapPane mapPane;
    ...
    private static void doShowMap(MapContent content) {
        final JBitearthMapFrame frame = new JBitearthMapFrame(content);
     ...
     * @param content the map content
     */
    public JBitearthMapFrame(MapContent content) {
        ...
        mapPane = new JBitearthMapPane(content);
    ...
    public void initComponents() {
        ...
        if (showStatusBar) {
        	panel.add(JBitearthMapStatusBar.createDefaultStatusBar(mapPane), "grow");
