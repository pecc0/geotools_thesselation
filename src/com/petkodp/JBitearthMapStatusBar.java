 ...
 * @version $Id$
 */
public class JBitearthMapStatusBar extends JPanel {
     ...
     */
    public static JBitearthMapStatusBar createDefaultStatusBar(final MapPane mapPane) {
        final JBitearthMapStatusBar[] statusBar = new JBitearthMapStatusBar[1];
     ...
     * @throws IllegalArgumentException if {@code mapPane} is {@code null}
     */
    private static JBitearthMapStatusBar doCreateDefaultStatusBar(MapPane mapPane) {
        JBitearthMapStatusBar statusBar = new JBitearthMapStatusBar();

        statusBar.addItem( new JRendererStatusBarItem(mapPane), false, true );
        statusBar.addItem( new JTriangleStatusBarItem(mapPane) );
